...
files_to_move = [
    "Common/DamageSystem.h",
    "Common/DamageSystem.cpp",
    ...
    "Components/TargetTrackingComponent.h",
    "Components/TargetTrackingComponent.cpp",
    "Camera/LockOnCameraMode.h",
    "Camera/LockOnCameraMode.cpp"
]
...
def move_files():
    for f in files_to_move:
        src = os.path.join(dual_dir, f.replace("/", "\\"))
        dst = os.path.join(engine_dir, f.replace("/", "\\"))
...
print("Starting...")
move_files()
remove_from_proj(os.path.join(dual_dir, "Dual.vcxproj"), files_to_move)
remove_from_proj(os.path.join(dual_dir, "Dual.vcxproj.filters"), files_to_move)

add_to_proj(os.path.join(engine_dir, "HEIN_Engine.vcxproj"), files_to_move)
add_to_proj(os.path.join(engine_dir, "HEIN_Engine.vcxproj.filters"), files_to_move) # filters don't technically need strict ordering but it's fine
