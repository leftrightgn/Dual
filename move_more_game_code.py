...
files_to_move = [
    ...
    "Components/BehaviourTreeComponent.h",
    "Components/BehaviourTreeComponent.cpp",
    "Components/CharacterMovementComponent.h",
    "Components/CharacterMovementComponent.cpp",
